...
"[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/utils.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const protobuf = tslib_1.__importStar(__turbopack_context__.r("[project]/node_modules/.pnpm/protobufjs@7.4.0/node_modules/protobufjs/light.js [app-client] (ecmascript)"));
...
exports.createMessageFromType = createMessageFromType; //# sourceMappingURL=utils.js.map
}),
"[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/decode.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const utils_1 = __turbopack_context__.r("[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/utils.js [app-client] (ecmascript)");
...
exports.decodeMessage = decodeMessage; //# sourceMappingURL=decode.js.map
}),
"[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/encode.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const light_1 = __turbopack_context__.r("[project]/node_modules/.pnpm/protobufjs@7.4.0/node_modules/protobufjs/light.js [app-client] (ecmascript)");
const utils_1 = __turbopack_context__.r("[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/utils.js [app-client] (ecmascript)");
...
const encode = (Message, data)=>{
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$1_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$macros$40$3$2e$1$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(bytes);
};
...
exports.encodeMessage = encodeMessage; //# sourceMappingURL=encode.js.map
}),
"[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/messages.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
})(TezosBallotType || (exports.TezosBallotType = TezosBallotType = {})); //# sourceMappingURL=messages.js.map
}),
"[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/load-definitions.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
exports.loadDefinitions = loadDefinitions; //# sourceMappingURL=load-definitions.js.map
}),
"[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/messages-schema.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
exports.HDNodePathType = schema_utils_1.Type.Object({
    node: schema_utils_1.Type.Union([
        exports.HDNodeType,
...
exports.TxOutputType = schema_utils_1.Type.Union([
    ...
    schema_utils_1.Type.Object({
        address: schema_utils_1.Type.Optional(schema_utils_1.Type.Undefined()),
        address_n: schema_utils_1.Type.Optional(schema_utils_1.Type.Undefined()),
        amount: schema_utils_1.Type.Union([
...
exports.TxAckResponse = schema_utils_1.Type.Union([
    schema_utils_1.Type.Object({
        inputs: schema_utils_1.Type.Array(schema_utils_1.Type.Union([
            exports.TxInputType,
            exports.PrevInput
        ]))
    }),
...
exports.FirmwareUpload = schema_utils_1.Type.Object({
    payload: schema_utils_1.Type.Union([
...
exports.Features = schema_utils_1.Type.Object({
    ...
    bootloader_mode: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    device_id: schema_utils_1.Type.Union([
        schema_utils_1.Type.String(),
        schema_utils_1.Type.Null()
    ]),
    pin_protection: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    passphrase_protection: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    language: schema_utils_1.Type.Union([
        schema_utils_1.Type.String(),
        schema_utils_1.Type.Null()
    ]),
    ...
    initialized: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    revision: schema_utils_1.Type.Union([
        schema_utils_1.Type.String(),
        schema_utils_1.Type.Null()
    ]),
    bootloader_hash: schema_utils_1.Type.Union([
        schema_utils_1.Type.String(),
        schema_utils_1.Type.Null()
    ]),
    imported: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    unlocked: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    _passphrase_cached: schema_utils_1.Type.Optional(schema_utils_1.Type.Boolean()),
    firmware_present: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    backup_availability: schema_utils_1.Type.Union([
        exports.BackupAvailability,
        schema_utils_1.Type.Null()
    ]),
    flags: schema_utils_1.Type.Union([
        schema_utils_1.Type.Number(),
        schema_utils_1.Type.Null()
    ]),
    model: schema_utils_1.Type.String(),
    fw_major: schema_utils_1.Type.Union([
        schema_utils_1.Type.Number(),
        schema_utils_1.Type.Null()
    ]),
    fw_minor: schema_utils_1.Type.Union([
        schema_utils_1.Type.Number(),
        schema_utils_1.Type.Null()
    ]),
    fw_patch: schema_utils_1.Type.Union([
        schema_utils_1.Type.Number(),
        schema_utils_1.Type.Null()
    ]),
    fw_vendor: schema_utils_1.Type.Union([
        schema_utils_1.Type.String(),
        schema_utils_1.Type.Null()
    ]),
    unfinished_backup: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    no_backup: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    recovery_status: schema_utils_1.Type.Union([
        exports.RecoveryStatus,
        schema_utils_1.Type.Null()
    ]),
    capabilities: schema_utils_1.Type.Array(exports.Capability),
    backup_type: schema_utils_1.Type.Union([
        exports.BackupType,
        schema_utils_1.Type.Null()
    ]),
    sd_card_present: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    sd_protection: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    wipe_code_protection: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    session_id: schema_utils_1.Type.Union([
        schema_utils_1.Type.String(),
        schema_utils_1.Type.Null()
    ]),
    passphrase_always_on_device: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
    safety_checks: schema_utils_1.Type.Union([
        exports.SafetyCheckLevel,
        schema_utils_1.Type.Null()
    ]),
    auto_lock_delay_ms: schema_utils_1.Type.Union([
        schema_utils_1.Type.Number(),
        schema_utils_1.Type.Null()
    ]),
    display_rotation: schema_utils_1.Type.Union([
        exports.DisplayRotation,
        schema_utils_1.Type.Null()
    ]),
    experimental_features: schema_utils_1.Type.Union([
        schema_utils_1.Type.Boolean(),
        schema_utils_1.Type.Null()
    ]),
...
exports.ApplySettings = schema_utils_1.Type.Object({
    ...
    display_rotation: schema_utils_1.Type.Optional(schema_utils_1.Type.Union([
        exports.DisplayRotation,
        exports.EnumEnum_DisplayRotation
    ])),
...
exports.StellarSignTx = schema_utils_1.Type.Object({
    ...
    memo_hash: schema_utils_1.Type.Optional(schema_utils_1.Type.Union([
        schema_utils_1.Type.Buffer(),
        schema_utils_1.Type.String()
    ])),
...
exports.StellarSetOptionsOp = schema_utils_1.Type.Object({
    ...
    signer_key: schema_utils_1.Type.Optional(schema_utils_1.Type.Union([
        schema_utils_1.Type.Buffer(),
        schema_utils_1.Type.String()
    ])),
...
exports.TezosOriginationOp = schema_utils_1.Type.Object({
    ...
    script: schema_utils_1.Type.Union([
        schema_utils_1.Type.String(),
...
"[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const tslib_1 = __turbopack_context__.r("[project]/node_modules/.pnpm/tslib@2.8.1/node_modules/tslib/tslib.es6.mjs [app-client] (ecmascript)");
const long_1 = tslib_1.__importDefault(__turbopack_context__.r("[project]/node_modules/.pnpm/long@5.2.5/node_modules/long/umd/index.js [app-client] (ecmascript)"));
const protobuf = tslib_1.__importStar(__turbopack_context__.r("[project]/node_modules/.pnpm/protobufjs@7.4.0/node_modules/protobufjs/light.js [app-client] (ecmascript)"));
const decode_1 = __turbopack_context__.r("[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/decode.js [app-client] (ecmascript)");
const encode_1 = __turbopack_context__.r("[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/encode.js [app-client] (ecmascript)");
const utils_1 = __turbopack_context__.r("[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/utils.js [app-client] (ecmascript)");
_a = (()=>{
...
exports.Messages = tslib_1.__importStar(__turbopack_context__.r("[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/messages.js [app-client] (ecmascript)"));
var load_definitions_1 = __turbopack_context__.r("[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/load-definitions.js [app-client] (ecmascript)");
...
exports.MessagesSchema = tslib_1.__importStar(__turbopack_context__.r("[project]/node_modules/.pnpm/@trezor+protobuf@1.4.4_tslib@2.8.1/node_modules/@trezor/protobuf/lib/messages-schema.js [app-client] (ecmascript)")); //# sourceMappingURL=index.js.map
}),
]);

//# sourceMappingURL=7deb4_%40trezor_protobuf_lib_e90d451a._.js.map